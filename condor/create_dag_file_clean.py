...
out_folder = '/hdfs/user/mcoughlin/CLEAN_DeepClean/'
# name of the submission file
sub_file = '/home/mcoughlin/DeepClean/condor/DeepClean_clean.sub'

# GPS times: if a list is passed, only the listed GPS times are used
# gps = [1241501951, 1241390460, 1241381956, 1240287152, 1240065469, 1239295624, 1239009856]
gps = []

if len(gps):
    segments = [s for s in segments if s[1] in gps]
